<div style="background: linear-gradient(to right, #141e30, #243b55); padding: 20px; border-radius: 10px; text-align: center; color: white;">
...
<div style="background-color: #2c3e50; padding: 20px; border-radius: 8px; color: #ecf0f1; font-family: Arial, sans-serif;">
  <h3 style="font-size: 24px; font-weight: bold;">Stay Updated with the Latest in Cybersecurity and Networking</h3>
